...
def trading_decision_contract(
    ...
    row_shape["watch_plan"] = {
        ...
        "review_after_minutes": "integer 15..240 trading minutes; default 30; queues a deduplicated due review, subject to session alignment, account lock and separate review budget; not a guaranteed completion time",
